...
import exclusivimg from "../img/Transportbikefrompune.jpg";
  ...
  return (
    <div className="whole-component">
      ...
      <div className="main-wrapper row pr-2 exclusive-wrap" style={{backgroundImage: `url(${exclusivimg})`}}>
        {/* <img src={exclusivimg} className="exclusive-bg" alt="bike shipment service from pune" /> */}
        <div className="content-wrapper col-md-7 exclusive-content">
          <h1>Affordable Bike Parcel, Shifting, and Moving Rates in Pune</h1>
          <br />

          <ul className="bullet-features">
            <li>Reliable and budget-friendly bike parcel, shifting, and moving services in Pune</li>
            ...
            <li>Secure delivery of two-wheelers across major Pune localities like Kothrud, Aundh, Baner, Viman Nagar, and Hadapsar</li>
          ...
          <h4 style={{ textAlign: "left", paddingLeft: "20px" }}>
            For any assistance <a href="tel:9014044900"><img src={callicon} alt="Bike Transportation services from Pune" width="40px"/></a>  or <a href="//api.whatsapp.com/send?phone=919014044900&text=Hi, I want to use your transportation services"><img src={whatsappicon} alt="Bike Transportation from Pune" width="40px" /></a> us at
          </h4>
          <h3
            style={{
              textAlign: "left",
